/*
 * Phase 16: 64-bit AXI-Stream pre-packed tiled matrix multiply
 *
 * MM2S input stream:
...
int main()
{
    ...
    xil_printf("Phase 16 64-bit stream tiled test (%dx%d, tile=%d)\r\n",
    ...
    if (errors == 0) {
        xil_printf("PHASE 16 64-BIT STREAM %dx%d PASS\r\n",
                   FULL_SIZE, FULL_SIZE);
    } else {
        xil_printf("PHASE 16 64-BIT STREAM %dx%d FAIL: %d errors\r\n",
