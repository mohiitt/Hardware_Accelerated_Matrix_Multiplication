...
proc create_root_design { parentCell } {
  ...
  set matrix_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:matrix_accel_axis64:1.0 matrix_accel_0 ]
...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matrix_accel_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net matrix_accel_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins matrix_accel_0/M_AXIS]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins matrix_accel_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matrix_accel_0/s00_axi/reg0] -force
